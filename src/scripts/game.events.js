(function (window) {
	...
	define([
		 ...
		 * @event game:panel:close             Requests the panel closing
		 * @event game:panel:pause             Requests the pause panel opening
		 * @event game:panel:settings          Requests the settings panel opening
		 * @event game:panel:user              Requests the user panel opening
		 ...
		 * @event game:settings:update         Requests an update of the settings
		 ...
		 * @event game:error                   An error occured
