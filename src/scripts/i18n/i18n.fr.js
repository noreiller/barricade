define([], function () {
	...
	var I18N = {
		...
		, end_title: 'La partie est terminée.'
		...
		, game_player_lost: '%name a perdu la partie.'
		, game_player_lost_self: 'Vous avez perdu la partie.'
		...
		, game_player_won: "%name a gagné la partie."
		, game_player_won_self: "Vous avez gagné la partie."
		, pause_title: "Pause"
		, rules: "Règles du jeu"
